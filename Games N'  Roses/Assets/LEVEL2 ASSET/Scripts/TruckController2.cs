...
public class TruckController2 : MonoBehaviour
{
    ...
    void TpBoxToKitchen2()
    {

        float x = TpBoxpoints.transform.position.x;
        float y = TpBoxpoints.transform.position.y;
        float z = TpBoxpoints.transform.position.z;
